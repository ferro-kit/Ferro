...
fn run_vacf(args: &Cli, traj: &molflow_core::Trajectory) -> Result<()> {
...
fn run_rotcorr(args: &Cli, traj: &molflow_core::Trajectory) -> Result<()> {
...
fn run_vanhove(args: &Cli, traj: &molflow_core::Trajectory) -> Result<()> {
