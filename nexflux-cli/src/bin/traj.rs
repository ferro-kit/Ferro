...
fn run_gr(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
    let params = GrParams {
        r_max: args.r_max,
        dr: args.dr,
        r_cut: args.r_cut,
...
fn run_sq(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
...
fn run_msd(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
...
fn run_angle(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
