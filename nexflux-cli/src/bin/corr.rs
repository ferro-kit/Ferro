...
fn run_vacf(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
...
fn run_rotcorr(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
...
fn run_vanhove(args: &Cli, traj: &nexflux_core::Trajectory) -> Result<()> {
