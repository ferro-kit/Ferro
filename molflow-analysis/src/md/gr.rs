...
/// molflow package version (from Cargo.toml)
...
pub(super) fn elem_z(symbol: &str) -> u8 {
    use molflow_core::data::elements::by_symbol;
...
mod tests {
    ...
    fn test_write_gr_and_cn() {
        ...
        let gr_path = "/tmp/test_molflow.gr";
        let cn_path = "/tmp/test_molflow.cn";
        ...
        assert!(gr_content.starts_with("# molflow v"));
