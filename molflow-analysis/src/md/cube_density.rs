...
//!
//! 输出为 [`CubeData`]，可直接用 `molflow_io::write_cube` 写出 Gaussian cube 文件，
//! 供 VESTA / VMD 等软件可视化。
//!
//! **CLI 参数**（供未来 molflow-cli 接入，记录在此）：
...
use molflow_core::{CubeData, Frame, Trajectory};
...
/// Pass it directly to `molflow_io::write_cube` to produce a Gaussian cube file.
